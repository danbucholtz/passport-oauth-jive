...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get(config.userEndpointUrl, accessToken, function (err, body, res) {
...
var customDataHook = function(profile){
  console.log("99% of the time you are going to need to do something more interesting here such as load a users permission groups or something.  That's on you, however.  It is a drag.  Also, there is probably a much better way to hook into this.  I'd love feedback.");
  done(null, profile);
};
