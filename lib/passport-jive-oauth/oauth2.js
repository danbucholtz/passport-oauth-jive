...
/**
 * Retrieve user profile from jive.
 *
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('http://localhost:8080/api/core/v3/people/@me', accessToken, function (err, body, res) {
...
/**
 * Return extra jive-specific parameters to be included in the authorization
 * request.
 * 
 * Check out The Google passport oauth implementation for additional details on this.  I have no idea
...
Strategy.prototype.authorizationParams = function(options) {
  ...
  if (options.prompt) {
    ...
    // However, it was detailed by Breno de Medeiros (who works at jive) in
